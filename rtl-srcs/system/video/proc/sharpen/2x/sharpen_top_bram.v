...
module sharpen_top_bram (
    ...
    always @(*) begin
        ...
        case (state_current)
            S_IDLE: begin state_next = S_REQ; ram_wrsel_flag=ram_wrsel_flag;ram_rdsel_flag=ram_rdsel_flag;end
            S_REQ: begin state_next = i_bicubic_en?S_LOAD1:S_REQ; ram_wrsel_flag=ram_wrsel_flag;ram_rdsel_flag=ram_rdsel_flag;end
            S_LOAD1: begin
                if(pixel_load_cnt < RAW_PIXEL_COUNT - 1) begin state_next = S_LOAD1;ram_wrsel_flag=ram_wrsel_flag;ram_rdsel_flag=ram_rdsel_flag;end
                else begin 
                    state_next=S_SWICH1;
                    ram_rdsel_flag=ram_rdsel_flag;
                    case(ram_wrsel_flag)
            ...
            S_SWICH1: begin state_next = S_LOAD2_CALC1;ram_wrsel_flag=ram_wrsel_flag;ram_rdsel_flag=ram_rdsel_flag;end
            S_LOAD2_CALC1:begin
                if(pixel_load_cnt < RAW_PIXEL_COUNT - 1) begin state_next = S_LOAD2_CALC1;ram_wrsel_flag=ram_wrsel_flag;ram_rdsel_flag=ram_rdsel_flag;end
                else begin 
                    state_next=S_SWICH2;
                    case(ram_wrsel_flag)
                        0:ram_wrsel_flag=ram_wrsel_flag+1;
            ...
            S_SWICH2: begin state_next = S_CALC2; ram_wrsel_flag=ram_wrsel_flag;ram_rdsel_flag=ram_rdsel_flag;end
            // S_CALC2: state_next = (calc_cnt == RAW_PIXEL_COUNT - 1) ? S_WRITE1 : S_CALC2;
            
            S_CALC2: begin
                if (calc_cnt != 255) begin
                    state_next = S_CALC2;ram_wrsel_flag=ram_wrsel_flag;ram_rdsel_flag=ram_rdsel_flag;
                end else begin
                    if(v_cnt == RAW_PIXEL_COUNT - 1) begin
                    state_next=S_FINAL;
                    ram_rdsel_flag=0;
                    ram_wrsel_flag=ram_wrsel_flag;
                    end
                    else begin
                        state_next=S_NEXT;
                        ram_wrsel_flag=ram_wrsel_flag;
            ...
            //     end
            // end
            S_NEXT: begin state_next = S_REQ;ram_wrsel_flag=ram_wrsel_flag;ram_rdsel_flag=ram_rdsel_flag;end
            S_FINAL: begin state_next = S_FINAL;ram_wrsel_flag=ram_wrsel_flag;ram_rdsel_flag=ram_rdsel_flag;end
