...
module e203_subsys_perips (
    ...
    /** Video System **/
    wire                       vsys_apb_icb_cmd_valid;
    wire                       vsys_apb_icb_cmd_ready;
    wire [             32-1:0] vsys_apb_icb_cmd_addr;
    wire                       vsys_apb_icb_cmd_read;
    wire [             32-1:0] vsys_apb_icb_cmd_wdata;
    wire [             4 -1:0] vsys_apb_icb_cmd_wmask;
    wire                       vsys_apb_icb_rsp_valid;
    wire                       vsys_apb_icb_rsp_ready;
    wire [             32-1:0] vsys_apb_icb_rsp_rdata;
    wire                       vsys_apb_icb_rsp_err;
    ...
    sirv_icb1to16_bus #(
        ...
        .o15_icb_cmd_valid(vsys_apb_icb_cmd_valid),
        .o15_icb_cmd_ready(vsys_apb_icb_cmd_ready),
        .o15_icb_cmd_addr (vsys_apb_icb_cmd_addr),
        .o15_icb_cmd_read (vsys_apb_icb_cmd_read),
        .o15_icb_cmd_wdata(vsys_apb_icb_cmd_wdata),
        .o15_icb_cmd_wmask(vsys_apb_icb_cmd_wmask),
        .o15_icb_cmd_lock (),
        .o15_icb_cmd_excl (),
        .o15_icb_cmd_size (),
        .o15_icb_cmd_burst(),
        ...
        .o15_icb_rsp_valid  (vsys_apb_icb_rsp_valid),
        .o15_icb_rsp_ready  (vsys_apb_icb_rsp_ready),
        .o15_icb_rsp_err    (vsys_apb_icb_rsp_err),
        .o15_icb_rsp_excl_ok(1'b0),
        .o15_icb_rsp_rdata  (vsys_apb_icb_rsp_rdata),
    ...
    assign i_aon_icb_cmd_pack                                      = {i_aon_icb_cmd_addr, i_aon_icb_cmd_read, i_aon_icb_cmd_wdata};

    assign {aon_icb_cmd_addr, aon_icb_cmd_read, aon_icb_cmd_wdata} = aon_icb_cmd_pack;
    ...
    assign aon_icb_rsp_pack                         = {aon_icb_rsp_err, aon_icb_rsp_rdata};

    assign {i_aon_icb_rsp_err, i_aon_icb_rsp_rdata} = i_aon_icb_rsp_pack;
    ...
    /** APB PERIPH: VIDEO SYSTEM **/
    sirv_gnrl_icb2apb #(
        .AW(32),
        .DW(`E203_XLEN)
    ) u_vsys_apb2icb (
        .i_icb_cmd_valid(vsys_apb_icb_cmd_valid),
        .i_icb_cmd_ready(vsys_apb_icb_cmd_ready),
        .i_icb_cmd_addr (vsys_apb_icb_cmd_addr),
        .i_icb_cmd_read (vsys_apb_icb_cmd_read),
        .i_icb_cmd_wdata(vsys_apb_icb_cmd_wdata),
        .i_icb_cmd_wmask(vsys_apb_icb_cmd_wmask),
        .i_icb_cmd_size (),

        .i_icb_rsp_valid(vsys_apb_icb_rsp_valid),
        .i_icb_rsp_ready(vsys_apb_icb_rsp_ready),
        .i_icb_rsp_rdata(vsys_apb_icb_rsp_rdata),
        .i_icb_rsp_err  (vsys_apb_icb_rsp_err),

        .apb_paddr  (VSYS_APB_PADDR),
        .apb_pwrite (VSYS_APB_PWRITE),
        .apb_pselx  (VSYS_APB_PSEL),
        .apb_penable(VSYS_APB_PENABLE),
        .apb_pwdata (VSYS_APB_PWDATA),
        .apb_prdata (VSYS_APB_PRDATA),

        .clk  (clk),
        .rst_n(bus_rst_n)
    );
    assign VSYS_APB_HCLK    = clk;
    assign VSYS_APB_HRESETn = bus_rst_n;
