...
#
# Generated by export_simulation on Fri Oct 20 22:56:17 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './vpu_config_ram.sh' script.

./vpu_config_ram.sh -reset_run
...
./vpu_config_ram.sh -noclean_files

For more information on the script, please type './vpu_config_ram.sh -help'.
